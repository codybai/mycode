...
public class OKHttplistAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            convertView = View.inflate(context, R.layout.item_okhttp_list,null);   //convertView绑定一个item style，以便于比较风格一样进行后面的优化操作
            ...
            viewHolder = (ViewHolder) convertView.getTag();   //判断老的item能用就返回老的，不能用就创建一个新的
        }
        //根据位置得到数据
